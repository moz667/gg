...
### [X] Silence the Wailing (Chapter 1)
...
**NOTE THAT AS OF LAST EDIT THIS ACHIEVEMENT IS BUGGED FOR A LARGE NUMBER OF GAMERS AND MAY NOT UNLOCK FOR YOU.**

Since there are a number of ways different people have gotten this Achievement I have decided to separate this specific one with a list of ways, in order, that you COULD get it, if you do not have the bug that disables ability to unlock it despite doing all of the listed ways to get it. I recommend making a hard save right before you make the choice either way unless evil alignment. I will mention these methods again in the related category (map/picture aids will be in sections) they would be under, but for now want to specifically call out to this one.

Original Campaign CH 2 (fastest way to get):
1. There is a woman named Yvette upstairs in the Wink and Tickle. If you agree to help her get her baby back, you can refuse to give it back to her.
2. Alternatively, if you return it to her safely (may also need to give max gold option to help her), the baby (might) appear again at the end of chapter two at the Pinnacle of the Host Tower. There will be a corpse with a note that the body was a spy of Aarin Grend, and near the corpse, the baby. Pick up the baby and complete Ch 2 shortly after.

SoU (recommended way for later achievement related to this one):
...
You must get an epic spell from feats list to be able to use. There are: Mummy Dust (Spellcraft level 15), Dragon knight (SPC LVL 22), Greater Ruin (SPC LVL 25), Epic Mage Armor (SPC LVL 26), Hellball (SPC LVL 32), and Epic Warding (SPC LVL 34). Note that you will need to be a sorcerer or a wizard to get.

*EDIT: Thanks to Steam User Officer Hotpants Apr 9 @ 11:17pm:* Arcana: Epic Edition can also be acquired with a cleric...Specifically I was a chaotic good cleric with the Good & Healing domains who took the Hellball spell.
...
Reach Level 40, the max level your character can be. This does not need to be in a single base or prestige count, but combined number.
